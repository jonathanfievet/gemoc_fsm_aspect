...
public class TransitionAspectTransitionAspectContext {
  ...
  public static TransitionAspectTransitionAspectProperties getSelf(final Transition _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.semantics.k3project.TransitionAspectTransitionAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Transition, TransitionAspectTransitionAspectProperties> map = new java.util.WeakHashMap<gemoc.Transition, org.semantics.k3project.TransitionAspectTransitionAspectProperties>();
