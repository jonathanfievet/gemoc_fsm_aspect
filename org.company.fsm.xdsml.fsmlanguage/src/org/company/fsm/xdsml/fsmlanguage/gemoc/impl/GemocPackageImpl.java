...
public class GemocPackageImpl extends EPackageImpl implements GemocPackage {
	 ...
	 * @see org.company.fsm.xdsml.fsmlanguage.gemoc.GemocPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, org.company.fsm.xdsml.fsmlanguage.gemoc.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFSM_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.company.fsm.xdsml.fsmlanguage.gemoc.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_State(), this.getState(), null, "state", null, 0, -1, org.company.fsm.xdsml.fsmlanguage.gemoc.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_Transition(), this.getTransition(), null, "transition", null, 0, -1, org.company.fsm.xdsml.fsmlanguage.gemoc.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
