...
public class StateAspect {
  ...
  public static void step(final State _self, final String inputString) {
	final org.company.fsm.xdsml.fsmlanguage.aspects.StateAspectStateAspectProperties _self_ = org.company.fsm.xdsml.fsmlanguage.aspects.StateAspectStateAspectContext
			.getSelf(_self);
  ...
  public static FSM getFSM(final State _self) {
	...
	;
	return (org.company.fsm.xdsml.fsmlanguage.gemoc.FSM) result;
}
  ...
  private static FSM fsm(final State _self) {
    final org.company.fsm.xdsml.fsmlanguage.aspects.StateAspectStateAspectProperties _self_ = org.company.fsm.xdsml.fsmlanguage.aspects.StateAspectStateAspectContext.getSelf(_self);
    Object result = null;
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getFsm") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (org.company.fsm.xdsml.fsmlanguage.gemoc.FSM) ret;
    				} else {
    					return null;
    				}
    		}
