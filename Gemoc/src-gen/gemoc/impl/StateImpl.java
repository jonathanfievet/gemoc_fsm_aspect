 ...
 * </p>
 * <ul>
 *   <li>{@link gemoc.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link gemoc.impl.StateImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link gemoc.impl.StateImpl#getOutcoming <em>Outcoming</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public Transition getIncoming() {
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GemocPackage.STATE__INCOMING, oldIncoming,
							incoming));
			}
		}
		return incoming;
	...
	public NotificationChain basicSetIncoming(Transition newIncoming, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GemocPackage.STATE__INCOMING,
	...
	public void setIncoming(Transition newIncoming) {
		if (newIncoming != incoming) {
			...
			if (incoming != null)
				msgs = ((InternalEObject) incoming).eInverseRemove(this, GemocPackage.TRANSITION__STATE,
						Transition.class, msgs);
			if (newIncoming != null)
				msgs = ((InternalEObject) newIncoming).eInverseAdd(this, GemocPackage.TRANSITION__STATE,
						Transition.class, msgs);
			msgs = basicSetIncoming(newIncoming, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GemocPackage.STATE__INCOMING, newIncoming,
					newIncoming));
	}
	...
	public Transition getOutcoming() {
		if (outcoming != null && outcoming.eIsProxy()) {
			...
			if (outcoming != oldOutcoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GemocPackage.STATE__OUTCOMING,
							oldOutcoming, outcoming));
			}
		}
		return outcoming;
	}
	...
	public NotificationChain basicSetOutcoming(Transition newOutcoming, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GemocPackage.STATE__OUTCOMING, oldOutcoming, newOutcoming);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOutcoming(Transition newOutcoming) {
		if (newOutcoming != outcoming) {
			NotificationChain msgs = null;
			if (outcoming != null)
				msgs = ((InternalEObject) outcoming).eInverseRemove(this, GemocPackage.TRANSITION__SRC,
						Transition.class, msgs);
			if (newOutcoming != null)
				msgs = ((InternalEObject) newOutcoming).eInverseAdd(this, GemocPackage.TRANSITION__SRC,
						Transition.class, msgs);
			msgs = basicSetOutcoming(newOutcoming, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GemocPackage.STATE__OUTCOMING, newOutcoming,
					newOutcoming));
	}
